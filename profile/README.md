...
# Skills
[![Skills](https://skillicons.dev/icons?i=python,java,lua,c,cpp,swift,html,css,js,ts,vscode,idea,git,github,figma,eclipse,mongodb,postgres,express,nextjs,react,cmake,maven,windows,linux,apple)](https://skillicons.dev)

<h6>Note: not all my skills are displayed above</h6>

![Anurag's GitHub stats](https://github-readme-stats.vercel.app/api?username=mustafamalikdev&theme=transparent&show_icons=true)
